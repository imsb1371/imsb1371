const allProjects = [
  ...
  },
  {
    ...
    "liveUrl": "https://doi.org/10.32604/cmes.2022.020840",
    "content": "Built an image-based structural damage classification system using ensemble deep learning models. The approach combines multiple CNN architectures to improve reliability and outperform single-model baselines.\r\n\r\n**Technical highlights:**\r\n- Classifies damage types: flexural, shear, combined, and undamaged\r\n- Ensemble of CNNs with averaging, stacking, and DE-optimized weighting\r\n- Transfer learning with MobileNetV2 & NASNetMobile\r\n- Significantly outperforms standard models (VGG, ResNet)\r\n- Designed for rapid post-disaster structural assessment",
    "_meta": {
      "filePath": "Structural_Damage_Detection.md",
      "fileName": "Structural_Damage_Detection.md",
      "directory": ".",
      "extension": "md",
      "path": "Structural_Damage_Detection"
    }
  }
];
export {
